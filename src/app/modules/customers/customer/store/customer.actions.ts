...
export const setCustomer = createAction(CustomerActionTypes.SetCustomer, props<{ payload: Customer }>());
export const createCustomer = createAction(CustomerActionTypes.CreateCustomer, props<{ payload: Customer }>());
...
export const customerError = createAction(CustomerActionTypes.CustomerError, props<{ payload: string }>());
